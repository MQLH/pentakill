...
public class RedisUtil {
    ...
    static {
        ...
        try {
            ...
            //获取配置文件
            inputStream = RedisUtil.class.getResourceAsStream("redisConfig.properties");
            ...
            throw new RuntimeException("redis启动失败！", e);   
        }finally{
        	if (inputStream!=null) {
        		try {
					inputStream.close();
				} catch (IOException e) {
					throw new RuntimeException("redis资源关闭失败！", e);   
				}
			}
        }
    }
	 ...
	 */
	public String expire(String key,int time) {
		Jedis jedis = null;
		String value = null;
		try {
			jedis = getJedis();
